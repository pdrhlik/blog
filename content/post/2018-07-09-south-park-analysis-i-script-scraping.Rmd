...
IMDB actually has one more episode than Wikia scripts. Can you see, why is that? There is an episode called **Unaired Pilot** from season one and its episode number is zero. It is actually the first version of the official episode one. You can actually find the script for the pilot [here](https://southpark.wikia.com/wiki/The_Unaired_Pilot/Script). But I decided only to include the official episodes.
